...
/**
 * Questionaire for general in german
 */
export const QUESTIONS_GENERAL: Array<QuestionGroup> = [
  {
    GroupName: 'Teilzeit',
  ...
  },
  {
    ...
    Questions: [
      {
        Text: 'Verwendet die Firma in Stellenausschreibungen Phrasen wie: "Wir suchen einen dynamischen, ehrgeizigen und zielorientierten Projektleiter." oder "Als Sekretärin sind Sie die gute Seele des Teams"?',
        QuestionType: QuestionTypeEnum.RadioGroup,
        Answers: [
          { Answer: 'Ja', Rating: AnswerRatingEnum.Medium, Hint: 'Geschlechterrollenstereotypen und Klischees (wie z.B. "Wir suchen einen dynamischen, ehrgeizigen und zielorientierten Projektleiter." oder "Als Sekretärin sind Sie die gute Seele des Teams") sind zu vermeiden.' },
  ...
  },
  {
    ...
    Description: 'Frauen sorgen in Teams für mehr Diversität und einen vielfältigeren Blick auf das Produkt/die Dienstleistung/etc..',
    Questions: [
      {
        Text: 'Wie hoch ist der Frauenanteil in der Abteilung/Firma?',
        QuestionType: QuestionTypeEnum.PercentSlider,
        Answers: [
          { Answer: 0, Rating: AnswerRatingEnum.Bad, Hint: 'Die erste Frau/Mitarbeiterin zu gewinnen ist eher schwierig, da Frauen tendenziell lieber in Teams arbeiten, in denen es bereits Frauen gibt.' },
          { Answer: 10, Rating: AnswerRatingEnum.Medium, Hint: 'Frauen arbeiten tendenziell lieber in Teams, in denen es bereits Frauen gibt.' },
  ...
  },
  {
    ...
    Questions: [
      {
        Text: 'Eine Mitarbeiterin bitte den männlichen Kollegen um Hilfe bei einer Problemstellung im Betrieb. Als sie nach zweimaligem Erklären die Lösung noch nicht verstanden hat, meint der Kollege, dass es möglicherweise an ihren "langen Haaren" liegen würde. Wie wird diese Situation in der Firma beurteilt?',
        QuestionType: QuestionTypeEnum.RadioGroup,
        Answers: [
      ...
      {
        Text: 'Eine Mitarbeiterin verdient 10% weniger als ein männlicher Kollege bei gleicher Qualifikation. Wie geht die Firma damit um?',
        QuestionType: QuestionTypeEnum.RadioGroup,
        Answers: [
      ...
      {
        Text: 'Die Firma stellt die erste Frau in einem Team ein. Wie geht die Firma mit dieser Mitarbeiterin um?',
        QuestionType: QuestionTypeEnum.RadioGroup,
        Answers: [
  ...
  },
  {
    ...
    Questions: [
      {
        Text: 'Was für ein Arbeitszeitmodell bietet das Unternehmen den Mitarbeitenden an (bei mehreren Modellen bitte das flexibelste Modell wählen)?',
        QuestionType: QuestionTypeEnum.RadioGroup,
        Answers: [
      ...
      {
        Text: 'Von wo aus dürfen die Mitarbeitenden arbeiten?',
        QuestionType: QuestionTypeEnum.RadioGroup,
        Answers: [
      ...
      {
        Text: 'Was bietet das Unternehmen den Mitarbeitenden  zusätzlich an, um die Vereinbarkeit von Beruf und Familie zu vereinfachen?',
